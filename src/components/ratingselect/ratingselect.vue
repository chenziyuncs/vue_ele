  ...
  <div>
      <div class="ratingselect">
          <div class="rating-type border-1px">
              <span class="block positive" @click="chooseType(2)" :class="{active:selectType===2}">
                  {{desc.all}}<span class="count">{{ratings.length}}</span>
              </span>
              <span class="block positive" @click="chooseType(0)" :class="{active:selectType===0}">
                  {{desc.positive}}<span class="count" >{{positiveCount}}</span>
              </span>
              <span class="block negative" @click="chooseType(1)" :class="{active:selectType===1}">
